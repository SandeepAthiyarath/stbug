...
$vars->{'cf_relaffected'} = Bugzilla::Field->new({name => 'cf_relaffected'})->legal_values;
$vars->{'cf_relfixed'} = Bugzilla::Field->new({name => 'cf_relfixed'})->legal_values;
$vars->{'cf_reltarget'} = Bugzilla::Field->new({name => 'cf_reltarget'})->legal_values;
$vars->{'cf_relnote'} = Bugzilla::Field->new({name => 'cf_relnote'})->legal_values;
